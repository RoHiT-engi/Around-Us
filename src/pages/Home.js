...
const Home = () => {
  ...
  <details>
    ...
    <div class="faq__content">
      <p>There are lots of situations that can trigger these feelings. Differing in some way from your peers – by race, gender, sexual orientation, age, religion – can fuel a sense of being a fraud. It's also exacerbated when being measured or evaluated. Whatever the trigger, these feelings can lead to damaging habits.</p>
    </div>
  </details>
  ...
  <details>
    ...
    <div class="faq__content">
      <p>According to a 2020 review, 9%–82% of people experience impostor syndrome. The numbers may vary depending on who participates in a study. Many people experience symptoms for a limited time, such as in the first few weeks of a new job. For others, the experience can be lifelong.</p>
    </div>
  </details>
  ...
  <details>
    ...
    <div class="faq__content">
      <p>Imposter syndrome isn't a psychiatric diagnosis. This phenomenon is experienced equally by men and women and frequently coexists with depression and anxiety</p>
    </div>
  </details>
  ...
  <details>
    <summary>Can you be confident and have imposter syndrome?</summary>
    <div class="faq__content">
      <p>Everyone can experience a lack of confidence in their abilities from time to time. But people who experience impostor syndrome tend to be high achievers with diverse educational backgrounds and a fair amount of professional experience. Despite this, they may often experience feelings of inadequacy and self-doubt.</p>
    </div>
  </details>
  ...
  <details>
    ...
    <div class="faq__content">
      <p>Attention Deficit Hyperactivity Disorder (ADHD) and imposter syndrome are a common pairing. You just want to stop beating yourself up, to stop feeling like a failure no matter what you achieve. You want to feel good enough on the inside</p>
    </div>
  </details>
   </main>
</body>
